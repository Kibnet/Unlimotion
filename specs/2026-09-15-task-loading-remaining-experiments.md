...
| CI FIX | Reentrant UI projection | 0.99 | Финальный remote CI | Сохранить fix | Нет | Две CI попытки упали на одном Avalonia/DynamicData nested-update механизме | All-tasks projection delivery сериализована UI scheduler; UI class 18/18, reentrant cases 20/20, exact 10-pair benchmark green | `89ff952c`, `final-head-89ff952c-vs-main*` |
