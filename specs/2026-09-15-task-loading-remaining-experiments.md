...
- Перед финальным merge gate ветка rebased без конфликтов на `f58bb6fc`. Прямой post-rebase benchmark актуального main против final candidate завершил 5/5 пар и 10/10 процессов: startup Ready median 11,963→9,884 s, median paired delta −14,33% (4/5); Space B 6,930→5,230 s, −26,92% (4/5); возврат Space A 6,348→3,881 s, −39,89% (5/5). Полный маршрут быстрее 5/5, median paired delta −29,05%; Ready+Action median paired delta −14,62%/−14,40%/−17,61%. Peak private memory ниже на 5,39–13,29% median paired. Dataset fingerprint `49906522...567135A`; exe SHA-256 main/candidate `D80E10E3...17FE1D6`/`DAD33AD7...9E0126B`.
...
| PR FINAL | Rebase и прямой final-head benchmark | 0.99 | Только CI нового remote head | Commit/push и проверить CI | Нет | Пользователь запросил rebase и три merge gate | Rebase на `f58bb6fc`; final main→candidate: Ready −14,33%/−26,92%/−39,89%, полный маршрут −29,05%, 5/5; 12/12 процессов | `final-after-raw-watcher-vs-main/measurements.jsonl` |
