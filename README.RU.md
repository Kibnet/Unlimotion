...
## Как начать работать
Для создания задачи можно воспользоваться горячими клавишами или кнопками на правой панели сверху со знаком "➕"

### Горячие клавиши:
- **Ctrl+Enter** - Создать задачу на том же уровне, что и выбранная 
- **Shift+Enter** - Создать задачу на том же уровне, что и выбранная и заблокированную ей
