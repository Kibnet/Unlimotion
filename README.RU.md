...
- Ежедневные заметки имеют путь `Ежедневные/YYYY-MM-DD.md`. Быстрая запись добавляет текст в сегодняшний файл, а блочный Live Preview оставляет Markdown редактируемым.
