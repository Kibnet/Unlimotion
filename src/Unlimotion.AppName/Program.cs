...
const string partialAppNameServiceName = "AppNameDefinitionService";
const string partialAppNameServiceFileName = $"{partialAppNameServiceName}.cs";
const string solutionDirectoryName = "src";
const string defaultErrorMessage = "Failed to initialize application name, because";
const string generatedPartialAppServiceName = $"{partialAppNameServiceName}.pre-build.cs";
string? appFullName;
