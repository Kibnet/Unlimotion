...
internal sealed class StormScenarioContext
{
    ...
    public bool TaskCardLayoutTaskSetAvailable { get; set; }

    public bool TaskCardLayoutStoryBehaviorConfirmed { get; set; }
    ...
    public bool StorageMigrationTaskSetAvailable { get; set; }
    ...
    public bool GitConflictResolutionTaskSetAvailable { get; set; }
    public bool GitConflictResolutionStoryBehaviorConfirmed { get; set; }
    public GitConflictResolutionScenarioResult? GitConflictResolutionResult { get; set; }

    public bool GitBackupJobsTaskSetAvailable { get; set; }
    public bool GitBackupJobsStoryBehaviorConfirmed { get; set; }
    public GitBackupJobsScenarioResult? GitBackupJobsResult { get; set; }

    public bool SettingsAppearanceTaskSetAvailable { get; set; }
    public bool SettingsAppearanceStoryBehaviorConfirmed { get; set; }
    public SettingsAppearanceScenarioResult? SettingsAppearanceResult { get; set; }

    public bool SettingsStorageGitTaskSetAvailable { get; set; }
