...
```
/storage/emulated/0/unlimotion/src/Unlimotion.Android/bin/Debug/net10.0-android/com.Kibnet.Unlimotion-Signed.apk
```
Then install via:
```bash
termux-open /storage/emulated/0/unlimotion/src/Unlimotion.Android/bin/Debug/net10.0-android/com.Kibnet.Unlimotion-Signed.apk
```
